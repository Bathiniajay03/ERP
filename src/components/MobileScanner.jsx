...
export default function MobileScanner({
  ...
  const generateSerialNumbers = () => {
    ...
    // Use A as the default prefix if none is found to support your 'A260329X1' default case
    ...
    if (activeTab === 'po') {
      // PO Format: PO260329X1, PO260329X2...
      serials = Array.from({ length: qty }, (_, i) => {
        return {
          serialNumber: `PO${yy}${mm}${dd}X${i + 1}`,
          status: 'Available'
        };
      });
    } else {
      // Manual IN/OUT/TRANSFER Format: A260329X1, A260329X2...
      serials = Array.from({ length: qty }, (_, i) => {
        return {
          serialNumber: `${serialPrefix}${yy}${mm}${dd}X${i + 1}`,
          status: 'Available'
        };
      });
    }
